...
class TestGlobalCacheManager:
    ...
    def test_global_cache_manager_get_stats(self) -> None:
    ...
    def test_global_cache_manager_get_cache(self) -> None:
        """Test getting cache instance from global manager."""
        global_cache = fastslide.GlobalCacheManager.instance()

        cache_instance = global_cache.get_cache()
    ...
    def test_global_cache_concurrent_access(self) -> None:
        ...
        def worker(thread_id: int) -> None:
            try:
                ...
                # Get stats again
                new_stats = global_cache.get_stats()
                assert new_stats.capacity > 0

                results.append((thread_id, new_stats.capacity))
