...
def build_model(
    ...
    if "vit" in args.arch:
        vit_kwargs = dict(
            ...
            embed_layer=args.embed_layer if hasattr(args, "embed_layer") else PatchEmbed3d,
...
def build_model_from_cfg(cfg: DictConfig, only_teacher: bool = False):
    return build_model(
        cfg.student,
