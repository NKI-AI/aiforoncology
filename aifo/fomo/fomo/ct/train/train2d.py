...
from fomo.ct.augmentations import DataAugmentationCTBatch2d, DataAugmentationCTSingle2d
...
def do_train(cfg, model, resume=False):
    ...
    img_size = (
        cfg.crops.global_crops_size[-1]
        if isinstance(cfg.crops.global_crops_size, ListConfig)
    ...
    data_transform_single = DataAugmentationCTSingle2d(
    ...
    data_transform_batch = DataAugmentationCTBatch2d(
        dtype=inputs_dtype,
    )
