...
import torch
from research.models.base_jit_model import BaseAhcoreJitModel
from research.utils.types import SegmentationOutputMode
from torch.jit import ScriptModule


class SegmentationJitModel(BaseAhcoreJitModel):
    """
    This class is a wrapper for the segmentation models in research.
