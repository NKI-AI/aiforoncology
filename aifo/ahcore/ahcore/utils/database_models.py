...
class Image(Base):
    ...
    annotation: Mapped["ImageAnnotations"] = relationship(
        "ImageAnnotations", back_populates="images", foreign_keys=[annotation_id]
    )
...
class ImageAnnotations(Base):
    ...
    images: Mapped[List["Image"]] = relationship(
        "Image", back_populates="annotation", foreign_keys="Image.annotation_id"
    )
