...
import torch
from dlup.data.dataset import Dataset, SlideDataset
...
class DlupDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        ----------
        data_description : DataDescription
            See `research.utils.data.DataDescription` for more information.
        pre_transform : Callable
            ...
            `SlideAnnotations` to a mask or similar.
        batch_size : int
    ...
    def setup(self, stage: str) -> None:
        ...
        def dataset_iterator() -> Generator[SlideDataset, None, None]:
    ...
    def _construct_concatenated_dataloader(
        ...
        if len(dataset) == 0 and stage == "fit":
            raise RuntimeError("Dataset for stage fit is empty.")
