...
if not OPENSLIDE_AVAILABLE:
    warnings.warn(
        "Openslide is not available. OpenSlide and Pyvips backends will not be available. To install it, run `pip install openslide-python`."
    )
else:
...
from .vips_backend import VipsSlide as VipsSlide  # noqa: F401
