...
class SlideImage:
    ...
    def color_profile(self) -> io.BytesIO | None:
        ...
        >>> # Now you can apply the transform to the region as a PIL Image (note that the output is pyvips.Image)
    ...
    def read_region(
        ...
        -------
        pyvips.Image
            The extract region as a pyvips.Image.
        ...
        # Lanczos typically uses 3 pixels as support.
        ...
        crop_box = (
            ...
            int(np.floor(fractional_coordinates[0] + native_size[0])),
            int(np.floor(fractional_coordinates[1] + native_size[1])),
        )
    ...
    def get_thumbnail(self, size: tuple[int, int] = (512, 512)) -> pyvips.Image:
        ...
        -------
        pyvips.Image
            The thumbnail as a pyvips.Image image.
        """
