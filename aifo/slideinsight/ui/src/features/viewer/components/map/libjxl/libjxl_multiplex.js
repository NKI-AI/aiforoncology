...
/** not-@type {!BigUint64Array} */
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("libjxl_multiplex.wasm");
    }
    // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
    return new URL("libjxl_multiplex.wasm", import.meta.url).href;
  }
  ...
  var _decode_jxl_multiplex = (Module["_decode_jxl_multiplex"] =
    makeInvalidEarlyAccess("_decode_jxl_multiplex"));
  var _decode_jxl_rgba = (Module["_decode_jxl_rgba"] =
    makeInvalidEarlyAccess("_decode_jxl_rgba"));
  var _get_compressed_data = (Module["_get_compressed_data"] =
    makeInvalidEarlyAccess("_get_compressed_data"));
  var _get_compressed_size = (Module["_get_compressed_size"] =
    makeInvalidEarlyAccess("_get_compressed_size"));
  var _get_decoded_data = (Module["_get_decoded_data"] =
    makeInvalidEarlyAccess("_get_decoded_data"));
  var _get_decoded_size = (Module["_get_decoded_size"] =
    makeInvalidEarlyAccess("_get_decoded_size"));
  var _get_decoded_rgba_data = (Module["_get_decoded_rgba_data"] =
    makeInvalidEarlyAccess("_get_decoded_rgba_data"));
  var _get_decoded_rgba_size = (Module["_get_decoded_rgba_size"] =
    makeInvalidEarlyAccess("_get_decoded_rgba_size"));
  var _get_rgba_bits_per_sample = (Module["_get_rgba_bits_per_sample"] =
    makeInvalidEarlyAccess("_get_rgba_bits_per_sample"));
  ...
  function assignWasmExports(wasmExports) {
    Module["_decode_jxl_multiplex"] = _decode_jxl_multiplex =
      createExportWrapper("decode_jxl_multiplex", 2);
    Module["_decode_jxl_rgba"] = _decode_jxl_rgba = createExportWrapper(
      "decode_jxl_rgba",
      2
    );
    Module["_get_compressed_data"] = _get_compressed_data = createExportWrapper(
      "get_compressed_data",
      0
    );
    Module["_get_compressed_size"] = _get_compressed_size = createExportWrapper(
      "get_compressed_size",
      0
    );
    Module["_get_decoded_data"] = _get_decoded_data = createExportWrapper(
      "get_decoded_data",
      0
    );
    Module["_get_decoded_size"] = _get_decoded_size = createExportWrapper(
      "get_decoded_size",
      0
    );
    Module["_get_decoded_rgba_data"] = _get_decoded_rgba_data =
      createExportWrapper("get_decoded_rgba_data", 0);
    Module["_get_decoded_rgba_size"] = _get_decoded_rgba_size =
      createExportWrapper("get_decoded_rgba_size", 0);
    Module["_get_rgba_bits_per_sample"] = _get_rgba_bits_per_sample =
      createExportWrapper("get_rgba_bits_per_sample", 0);
  ...
  function invoke_iiiiffjii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
    var sp = stackSave();
    try {
      return getWasmTableEntry(index)(a1, a2, a3, a4, a5, a6, a7, a8);
    } catch (e) {
