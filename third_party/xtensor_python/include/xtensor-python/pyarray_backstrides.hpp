...
template <class B>
inline pybackstrides_iterator<B>::pybackstrides_iterator(const B* b,
                                                         std::size_t offset)
...
template <class B>
inline auto pybackstrides_iterator<B>::operator[](difference_type n) const
    -> reference {
...
template <class B>
inline auto pybackstrides_iterator<B>::operator+=(difference_type n)
    -> self_type& {
  m_offset += n;
  return *this;
}
...
template <class B>
inline auto pybackstrides_iterator<B>::operator-(const self_type& rhs) const
    -> self_type {
  self_type tmp(*this);
...
template <class A>
inline auto pyarray_backstrides<A>::operator[](size_type i) const
    -> value_type {
