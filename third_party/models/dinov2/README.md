We have changed various parts of the codebase. For an example usecase, consider the mri fomo repository (src/python/research/mri_fomo).
The non-default configs and the main train script are placed in the project directory instead of here (since they differ per project).

For any project, make sure you add the aifo/models directory to your PYTHONPATH.
