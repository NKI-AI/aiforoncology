...
**_NOTE_**: Only original source code from you and other people that have signed
...
- Describe your commits. Add a meaningful description to your commit message,
  ...
  importantly explain _why_ you are making those changes. For example "Fix
...
- Testing: Test your change and explain in the commit message _how_ your
...
- Meaningful commit description: What and _why_, links to issues, testing
  procedure.
