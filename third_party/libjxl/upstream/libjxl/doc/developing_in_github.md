...
paste the contents of your _public key_ (the one ending in `.pub`), that would
...
request merges _to_ the upstream repository directly, there's no need to create
...
https://<!-- not a link -->github.com<!-- not a link -->/_{{USERNAME}}_/libjxl
...
Once you are ready to send your branch for review, upload it to _your_ fork:
...
_not_ automatically set those hashes to the ones of the branch or jpeg xl
