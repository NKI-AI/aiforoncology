...
_not_ affected. It is possible that stable distributions ship older versions
...
If the bug _is_ a covered security bug then follow the rest of this guide.
...
Work on a fix for the bug in _private_. Don't publish a Pull Request with the
