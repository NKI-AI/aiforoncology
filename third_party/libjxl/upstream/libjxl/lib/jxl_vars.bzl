...
libjxl_root_package = "_main/third_party/libjxl/upstream/libjxl"
...
libjxl_deps_hwy = ["@hwy//:hwy"]
libjxl_deps_hwy_nanobenchmark = ["@hwy//:nanobenchmark"]
libjxl_deps_hwy_test_util = ["@hwy//:hwy_test_util"]
...
libjxl_deps_testdata = ["//third_party/libjxl/upstream/libjxl:testdata"]
