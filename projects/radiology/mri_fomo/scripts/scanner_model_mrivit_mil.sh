...
#SBATCH --output=/home/v.v.veldhuizen/aiforoncology-internal/output/slurm/mri_fomo_eval_%A_%a.out
#SBATCH --error=/home/v.v.veldhuizen/aiforoncology-internal/output/slurm/mri_fomo_eval_%A_%a.err
...
eva fit --config /home/v.v.veldhuizen/aiforoncology-internal/src/python/research/fomo/mri/eval/configs/classification/scanner_model/scanner_model_mil_single.yaml
