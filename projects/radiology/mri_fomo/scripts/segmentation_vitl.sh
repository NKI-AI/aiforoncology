...
export BATCH_SIZE=1
export INCLUDE_BACKGROUND=true
export DATASET_NAME="duke"
# export MONITOR_METRIC="val/GeneralizedDiceScore"
eva fit --config /home/v.v.veldhuizen/aiforoncology-internal/src/python/research/fomo/mri/eval/configs/segmentation/tumor_segmentation_dino_cropped.yaml
