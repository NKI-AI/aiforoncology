...
eva predict_fit --config /home/v.v.veldhuizen/aiforoncology-internal/src/python/research/fomo/mri/eval/configs/classification/density/density_mil_single.yaml
