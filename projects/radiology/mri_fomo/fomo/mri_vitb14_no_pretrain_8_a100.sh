...
#SBATCH --output=mri_vitb14_%A_%a.out
#SBATCH --error=mri_vitb14_%A_%a.err
...
srun --export=ALL bazelisk run :dinov2_train_mri -- \
  --config-file fomo/mri/configs/train/mri_vitb14_no_pretrain.yaml \
