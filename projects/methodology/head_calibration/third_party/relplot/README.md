...
is cruicial, but is done _automatically_ by the code in a theorhetically-justified way.
...
In the multi-class setting, _confidence calibration_ can be measured by expressing it as the binary
